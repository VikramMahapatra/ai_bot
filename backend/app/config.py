...
class Settings(BaseSettings):
    ...
    ORG_CREDIT_DAEMON_MINUTE_UTC: int = 30
    ORG_CREDIT_DAEMON_INITIAL_DELAY_SECONDS: int = 15
    DUE_CAMPAIGN_DAEMON_INITIAL_DELAY_SECONDS: int = 15
    DUE_CAMPAIGN_DAEMON_BATCH_SIZE: int
    DUE_CAMPAIGN_DAEMON_MAX_BATCHES: int
    DUE_CAMPAIGN_DAEMON_INTERVAL_SECONDS: int = 900
    INBOUND_AGENT_CREDIT_DAEMON_INITIAL_DELAY_SECONDS: int = 35
    INBOUND_AGENT_CREDIT_DAEMON_BATCH_SIZE: int
    INBOUND_AGENT_CREDIT_DAEMON_MAX_BATCHES: int
    INBOUND_AGENT_CREDIT_DAEMON_INTERVAL_SECONDS: int = 900
    INBOUND_AGENT_CREDIT_MINIMUM: int = 100
    ZOHO_CONTACT_SYNC_DAEMON_INITIAL_DELAY_SECONDS: int = 15
    ZOHO_CONTACT_SYNC_DAEMON_INTERVAL_SECONDS: int = 900
    ZOHO_CONTACT_SYNC_DAEMON_BATCH_SIZE: int
    ZOHO_CONTACT_SYNC_DAEMON_MAX_BATCHES: int
    ZOHO_AUTOMATION_DAEMON_INITIAL_DELAY_SECONDS: int = 15
    ZOHO_AUTOMATION_DAEMON_INTERVAL_SECONDS: int = 900
    ZOHO_AUTOMATION_DAEMON_BATCH_SIZE: int
    ZOHO_AUTOMATION_DAEMON_MAX_BATCHES: int

    ZOHO_CALL_AUTOMATION_DAEMON_INITIAL_DELAY_SECONDS: int = 15
    ZOHO_CALL_AUTOMATION_DAEMON_INTERVAL_SECONDS: int = 900
    ZOHO_CALL_AUTOMATION_DAEMON_BATCH_SIZE: int
    ZOHO_CALL_AUTOMATION_DAEMON_MAX_BATCHES: int
    ...
    SMS_CAMPAIGN_SEND_INTERVAL_SECONDS: int = (
        60  # Minimum interval between sending messages to the same contact
    )
    WHATSAPP_CAMPAIGN_SEND_INTERVAL_SECONDS: int = (
        60  # Minimum interval between sending messages to the same contact
    )
