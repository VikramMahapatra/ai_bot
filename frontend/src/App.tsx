    ...
    components: {
        ...
        styleOverrides: {
          ...
          "*": {
            ...
            scrollbarColor: isDark
              ? "rgba(120,164,255,0.72) rgba(255,255,255,0.10)"
              : "rgba(53,96,201,0.62) rgba(53,96,201,0.16)",
          },
          "*::-webkit-scrollbar": {
            width: "10px",
            height: "10px",
          ...
          "*::-webkit-scrollbar-thumb": {
            backgroundColor: isDark
              ? "rgba(120,164,255,0.72)"
              : "rgba(53,96,201,0.62)",
            borderRadius: "10px",
            border: isDark
              ? "1px solid rgba(10,20,45,0.75)"
              : "1px solid rgba(255,255,255,0.85)",
          },
          "*::-webkit-scrollbar-thumb:hover": {
            backgroundColor: isDark
              ? "rgba(150,188,255,0.90)"
              : "rgba(41,79,171,0.88)",
          },
        },
      },
      MuiButton: {
        styleOverrides: {
          ...
          containedPrimary: {
            background:
              "linear-gradient(135deg, #3d75d9 0%, #4ca2df 55%, #57c4d3 100%)",
            boxShadow: "0 12px 24px rgba(44,101,178,0.26)",
            "&:hover": {
              background:
                "linear-gradient(135deg, #325fae 0%, #3f8bc1 55%, #47aab8 100%)",
      ...
      MuiPaper: {
        styleOverrides: {
          root: {
            ...
            borderRadius: 14,
            border: isDark
              ? `1px solid ${alpha("#89a8f8", 0.2)}`
              : `1px solid ${alpha("#ffffff", 0.6)}`,
            background: isDark
              ? alpha("#111b3a", 0.86)
            ...
            boxShadow: isDark
              ? "0 16px 34px rgba(2,8,28,0.42)"
              : "0 14px 30px rgba(43,79,139,0.16)",
          },
        },
      },
      MuiDialog: {
...
const ProtectedRoute: React.FC<{
  ...
  if (requiredRole === "ADMIN" && userRole !== "ADMIN") {
    return (
      <Navigate
        to={userRole === "USER_HANDOFF" ? "/handoff" : "/chat"}
        replace
      />
    );
  }
  ...
  if (
    requiredRole === "HANDOFF_OPERATOR" &&
    userRole !== "USER_HANDOFF" &&
    userRole !== "ADMIN"
  ) {
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route
        path="/credit-estimator/share/:token"
        element={<CreditEstimatorSharePage />}
      />
      <Route path="/superadmin/login" element={<SuperAdminLoginPage />} />
      <Route
        path="/superadmin/bootstrap"
        element={<SuperAdminBootstrapPage />}
      />
      <Route
        path="/superadmin"
        element={
